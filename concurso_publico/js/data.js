    ...
    },
    {
      ...
      "guide":{
        "intro":[
          ...
          "A Constituição de 1988 rompeu com esse modelo: a saúde deixou de ser benefício de quem contribui e passou a ser direito de todos e dever do Estado — a base do SUS."
        ],
        ...
        "articlesTitle":"O que a Constituição garante",
        "articles":[
          {"n":"6º","t":"Direito social","d":"A saúde é direito social, ao lado de educação, trabalho, moradia e previdência."},
          {"n":"196","t":"Direito de todos, dever do Estado","d":"Acesso universal e igualitário às ações e serviços de promoção, proteção e recuperação da saúde."},
          {"n":"197","t":"Relevância pública","d":"Ações e serviços de saúde são de relevância pública; cabe ao Poder Público regulamentar, fiscalizar e controlar."},
          {"n":"198","t":"Diretrizes do SUS","d":"Rede única, regionalizada e hierarquizada; descentralização, integralidade e participação da comunidade."},
          {"n":"199","t":"Iniciativa privada complementar","d":"A assistência à saúde é livre à iniciativa privada, de forma complementar ao SUS."},
          {"n":"200","t":"Competências do SUS","d":"Vigilância sanitária e epidemiológica, formação de recursos humanos, saneamento, fiscalização e inovação."}
        ],
