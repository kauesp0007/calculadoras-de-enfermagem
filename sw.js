const CACHE_VERSION = "20260802-021748";
...
const urlsToCache = [
  ...
  'cko-projeto/01-schema/biblioteca-cko-v1.schema.json',
  'cko-projeto/01-schema/cko-objeto-v1.schema.json',
  'cko-projeto/01-schema/linking-objects/AuditIndicatorRule.schema.json',
  'cko-projeto/01-schema/linking-objects/ClinicalPathway.schema.json',
  'cko-projeto/01-schema/linking-objects/ClinicalRule.schema.json',
  'cko-projeto/01-schema/linking-objects/DecisionTree.schema.json',
  'cko-projeto/01-schema/linking-objects/DrugDeviceMatrix.schema.json',
  'cko-projeto/01-schema/linking-objects/EvidenceReference.schema.json',
  'cko-projeto/01-schema/linking-objects/FHIRMapping.schema.json',
  'cko-projeto/01-schema/linking-objects/ProcedureProtocol.schema.json',
  'cko-projeto/01-schema/seringa-cko-v11.schema.json',
  'cko-projeto/02-bibliotecas/_drug-device-matrix.json',
  'cko-projeto/02-bibliotecas/agulhas.json',
  'cko-projeto/02-bibliotecas/antissepticos.json',
  'cko-projeto/02-bibliotecas/cateteres.json',
  'cko-projeto/02-bibliotecas/cirurgicos.json',
  'cko-projeto/02-bibliotecas/curativos.json',
  'cko-projeto/02-bibliotecas/drenos.json',
  'cko-projeto/02-bibliotecas/feridas.json',
  'cko-projeto/02-bibliotecas/luvas.json',
  'cko-projeto/02-bibliotecas/ostomias.json',
  'cko-projeto/02-bibliotecas/respiratorios.json',
  'cko-projeto/02-bibliotecas/seringa-10ml-luerlock.json',
  'cko-projeto/02-bibliotecas/seringa-20ml-luerlock.json',
  'cko-projeto/02-bibliotecas/seringa-3ml-luerlock.json',
  'cko-projeto/02-bibliotecas/seringa-5ml-luerlock.json',
  ...
  'cko-projeto/05-objetos-clinicos/_index.json',
  'cko-projeto/05-objetos-clinicos/assepsia.json',
  'cko-projeto/05-objetos-clinicos/calculadora-imc.json',
  'cko-projeto/05-objetos-clinicos/caso-sepse-01.json',
  'cko-projeto/05-objetos-clinicos/ceftriaxona.json',
  'cko-projeto/05-objetos-clinicos/escala-braden.json',
  'cko-projeto/05-objetos-clinicos/filtracao-glomerular.json',
  'cko-projeto/05-objetos-clinicos/flebite.json',
  'cko-projeto/05-objetos-clinicos/hemograma.json',
  'cko-projeto/05-objetos-clinicos/musculo-deltoide.json',
  'cko-projeto/05-objetos-clinicos/nanda-00046.json',
  'cko-projeto/05-objetos-clinicos/necrose.json',
  'cko-projeto/05-objetos-clinicos/nic-2312.json',
  'cko-projeto/05-objetos-clinicos/noc-0401.json',
  'cko-projeto/05-objetos-clinicos/nove-certos.json',
  'cko-projeto/05-objetos-clinicos/pressao-arterial.json',
  'cko-projeto/05-objetos-clinicos/protocolo-sepse.json',
  'cko-projeto/05-objetos-clinicos/puncao-venosa.json',
  'cko-projeto/05-objetos-clinicos/resolucao-cofen-588.json',
  'cko-projeto/05-objetos-clinicos/sepse.json',
  'cko-projeto/05-objetos-clinicos/seringa-20ml-luer-lock.json',
  'cko-projeto/05-objetos-clinicos/snomed-ct.json',
  'cko-projeto/05-objetos-clinicos/staphylococcus-aureus.json',
  'cko-projeto/05-objetos-clinicos/taxa-infeccao.json',
  'cko-projeto/05-objetos-clinicos/vacina-bcg.json',
  'convert-webp.js',
  'corrigir-badges.js',
