"""Corrige NIPS em todos os idiomas: } extra + cores para val>0"""
import os
...
# Fix 2: cores para val===1 e val===2
...
for d in dirs:
    ...
    if os.path.exists(f):
        ...
        if changed:
            ...
            print(f'{d} (ja corrigido ou nao encontrado)')
