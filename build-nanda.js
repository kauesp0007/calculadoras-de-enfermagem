...
<img src="/img/taxonomia_da_nanda_internacional_estrutura.webp" alt="Estrutura da Taxonomia NANDA Internacional" class="img-zoom w-auto max-w-[320px] mx-auto rounded-lg shadow-md" onclick="document.getElementById('modal-taxonomia').classList.add('active')" loading="lazy">
</div>
