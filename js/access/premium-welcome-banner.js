...
(function (window, document) {
  ...
  function account(){
    return (location.pathname||"").indexOf("/conta/")===0;
  }
  ...
  function init(){
    ...
    if(!bindAuth()){
      ...
      var retry=setInterval(function(){
        if(bindAuth()||++attempts>=50)clearInterval(retry);
      },100);
    }
