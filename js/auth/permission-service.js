...
(function(window){"use strict";
  ...
  function resolve(profile){var set={};function add(x){if(x==="ALL"){ALL.forEach(function(p){set[p]=true;});}else if(x)set[x]=true;}
    ...
    var plan=profile&&profile.plan==="premium"?"premium":"free";
    if(window.AuthorizationModules.planService)window.AuthorizationModules.planService.permissionsFor(plan).forEach(add);
