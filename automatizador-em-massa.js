...
const REGRA_REPLACE = [
    { target: '<div id="footer-placeholder"></div>', newTag: `<div class="ads-multiplex-container" style="min-height: 280px; margin: 2rem auto; width: 100%; max-width: 1280px; padding: 0 1rem;">
